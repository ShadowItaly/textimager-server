...
echo docker exec -ti textimager-server bash -c "su - ducc -c 'cd /home/ducc/ && /usr/local/openjdk-8/bin/java -cp DUCCServiceCreator.jar:/home/ducc/apache-uima-ducc/jars/* main.MainComandline $2 localhost'" 
docker exec -ti textimager-server bash -c "su - ducc -c 'cd /home/ducc/ && /usr/local/openjdk-8/bin/java -cp DUCCServiceCreator.jar:/home/ducc/apache-uima-ducc/jars/* main.MainComandline $2 localhost'" 
